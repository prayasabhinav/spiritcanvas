...
if (ENABLE_MONGODB) {
    ...
    let defaultPathwaysRaw = [
        ...
        { name: "Junior UX Designer", description: "Assist in designing user-friendly digital products" },
        ...
        { name: "Mobile App Design Assistant", description: "Support the design of mobile application interfaces" },
        { name: "Game UI/UX Assistant", description: "Help design user experiences for games" },
        { name: "User Research Assistant", description: "Support user research activities to inform design" },
        ...
        { name: "Junior Graphic Designer", description: "Assist in creating visual concepts for communication" },
        { name: "Brand Identity Assistant", description: "Support the creation of visual identities for brands" },
        { name: "Editorial Design Assistant", description: "Help design layouts for publications" },
        { name: "Packaging Design Assistant", description: "Assist in creating product packaging designs" },
        ...
        { name: "Icon Design Assistant", description: "Support the creation of icons for interfaces" },
        ...
        { name: "Muralist Assistant", description: "Help create large-scale paintings on walls" },
        ...
        { name: "Art Education Assistant", description: "Support art teaching activities" },
        { name: "Museum Operations Assistant", description: "Help with visitor services and collection care in museums" },
        ...
        { name: "Character Design Assistant", description: "Support the design of characters for media" },
        { name: "Storyboard Revisionist", description: "Make changes to storyboards based on feedback" },
        { name: "Junior VFX Artist", description: "Assist in creating visual effects" },
        { name: "Stop Motion Assistant", description: "Help create stop motion animations" },
        { name: "Motion Graphics Assistant", description: "Support the creation of motion graphics" },
        ...
        { name: "Photography Assistant", description: "Support photographers during shoots and post-production" },
        { name: "Photo Retoucher", description: "Edit and enhance digital photographs" },
        { name: "Video Editor Assistant", description: "Help edit video footage for various projects" },
        { name: "Production Assistant (Film/Video)", description: "Provide general support on film and video sets" },
        { name: "Camera Operator Assistant", description: "Support camera crews during filming" },
        ...
        { name: "Digital Imaging Technician (DIT) Assistant", description: "Help manage digital footage on set" },
        ...
        { name: "Textile Design Assistant", description: "Help create patterns and designs for fabrics" },
        ...
        { name: "Craft Studio Assistant", description: "Provide general support in a craft-based studio" },
        { name: "Materials Researcher", description: "Investigate and document materials for design use" },
        { name: "CAD Technician Assistant", description: "Help create technical drawings using CAD software" },

        // Digital Art Pathways - Updated for Entry-Level
        { name: "Junior Digital Artist", description: "Assist in creating artwork using digital tools" },
        { name: "Digital Painting Assistant", description: "Support digital painting workflows" },
        { name: "Creative Coding Assistant", description: "Help develop creative projects using code" },
        { name: "Junior 3D Artist (Generalist)", description: "Assist with various tasks in 3D production" },
        { name: "Interactive Media Assistant", description: "Support the design of interactive digital experiences" },
        ...
        { name: "Concept Art Assistant", description: "Support concept artists in visual development" },
        { name: "Digital Asset Manager Assistant", description: "Help organize and manage digital art files" },
